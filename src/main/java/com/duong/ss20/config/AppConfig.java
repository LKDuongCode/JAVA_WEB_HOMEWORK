...
@ComponentScan(basePackages = {
        "com.duong.ss20.controller",
        "com.duong.ss20.repository",
        "com.duong.ss20.service"
})
public class AppConfig  implements WebMvcConfigurer {
    ...
    public DataSource dataSource() {
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/ss20");
        ds.setUsername("root");
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        factory.setPackagesToScan("com.duong.ss20.entity"); // Nơi chứa các @Entity
